...
<header style="background-color: #333;">
    <div class="container-12" style="padding-top: 20px;">
        ...
        <div style="text-align: right" class="grid-9">
            <nav>        
                <a href="<?php print $base_path; ?>about" class="leftmost dark<?php
                    ...
                    ?>">
                            <div class="about-icon"></div><span> about</span></a><a href="<?php print $base_path; ?>join" class="dark<?php
                    ...
                    ?>">
                            <div class="join-icon"></div><span> join</span></a><a href="<?php print $base_path; ?>games" class="<?php
                        if (isset($node)) {
                        ...
                        ?>">
                            <div class="games-icon"></div><span> games</span></a><a href="<?php print $base_path; ?>events" class="<?php
                        if (isset($node)) {
                        ...
                        ?>">
                            <div class="events-icon"></div><span> events</span></a><a 
                            
                            <?php if ($user->uid): ?>
                                href="<?php print $base_path; ?>user/<?=$user->uid?>" class="<?php
                                    if (arg(0) == 'user') {
                                        print("chosen");
                                    }
                                    ?>">
                                    <div class="profile-icon"></div><span> <?php print $user->name; ?></span>
                                    
                            <?php else: ?>
                                href="<?php print $base_path; ?>user" class="<?php
                                    if (arg(0) == 'user') {
                                        print("chosen");
                                    }
                                    ?>">
                                    <div class="login-icon"></div><span> login/signup</span>
                                    
                            <?php endif; ?>
                        
                        </a><a href="#" class="dark">
                            <div class="search-icon"></div><span> search</span></a>
                        </nav>
        </div>
    </div>
</header>
